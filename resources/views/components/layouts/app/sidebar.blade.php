...
<body class="min-h-screen bg-white dark:bg-zinc-800">
  ...
  @if(auth()->user()->role === 'cashier')
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
      ...
      <a href="{{ route('cashier.dashboard') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate>
        <x-app-logo />
      </a>
      ...
      <flux:navlist variant="outline">
        <flux:navlist.group class="grid py-2 gap-1">
          <flux:navlist.item icon="home" :href="route('cashier.dashboard')" :current="request()->routeIs('cashier.dashboard')"
            wire:navigate>{{ __('Dashboard') }}</flux:navlist.item>
          <flux:navlist.item icon="bars-4" :href="route('cashier.menu')" :current="request()->routeIs('cashier.menu')" wire:navigate>
            {{ __('Menu') }}
          </flux:navlist.item>
